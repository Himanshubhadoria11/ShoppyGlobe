...
function CartItem({ data }) {
    ...
    return (
        <article className="flex flex-col min-[500px]:flex-row gap-x-5 shadow-lg max-w-[700px] rounded-lg bg-amber-100">
            <figure>
            ...
            <article className="min-[500px]:ml-auto mr-5 mt-4 flex flex-row min-[500px]:flex-col gap-x-3 min-[500px]:gap-y-1 ">
                <button onClick={incrementQuantity}><FontAwesomeIcon icon={faPlus} className="bg-red-400 text-white  rounded-md w-[60px] py-[8px]" /></button>
                <input
                    type="number"
                    value={data.quantity}
                    readOnly
                ...
                />
                <button onClick={decrementQuantity}><FontAwesomeIcon icon={faMinus} className="bg-red-400 text-white rounded-md w-[60px] py-[8px] mt-1" /></button>
            </article>
        </article>
    )
}
