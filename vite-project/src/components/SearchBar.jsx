...
//         // Normalize input to lowercase to ensure case-insensitive search
//         const normalizedInput = inputText.trim().toLowerCase();

//         const updatedData = baseData?.filter(data =>
//             data.title.toLowerCase().includes(normalizedInput) // Case-insensitive search
//         );

//         setFilteredData(updatedData);
//         setInputText(""); // Clear input field after search
//     }

//     return (
//         <section className="mt-8">
//             <form onSubmit={filterData} className="flex justify-center items-center gap-x-3">
//                 <input
//                     value={inputText}
//                     onChange={(e) => setInputText(e.target.value)}
//                     type="text"
...
//                     <FontAwesomeIcon 
//                         icon={faSearch} 
//                         className="bg-purple-700 text-white py-[15px] px-4 rounded-md text-lg" 
//                     />
//                 </button>
//             </form>
//         </section>
