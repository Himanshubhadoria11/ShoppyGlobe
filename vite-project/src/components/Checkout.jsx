...
function Checkout() {
    ...
    return (
        <>
            <section className="mt-20 min-[500px]:mt-28 px-5 min-h-[396px] pt-[40px]">
                <article className="relative">
                    <h1 className="text-3xl min-[500px]:text-4xl font-bold after:absolute after:w-28 after:h-[6px] after:rounded-lg text-red-600 after:bg-purple-700 after:-bottom-2 after:left-0">Checkout</h1>
                </article>
                <section className="mt-10 flex flex-col items-center relative">
                    <section className="shadow-lg py-6 px-5 rounded-xl bg-slate-100">
                        <article>
                            ...
                            <p className="text-[16px] min-[400px]:text-[17px] min-[600px]:text-xl font-semibold rounded-lg bg-white py-1 ps-2 pe-2 shadow-lg">Alice</p>
                        </article>
                        <article className="mt-5">
                            <p className="text-[13px] min-[400px]:text-[15px] min-[600px]:text-[17px] font-semibold">Delivered At</p>
                            <p className="text-[16px] min-[400px]:text-[17px] min-[600px]:text-xl font-semibold rounded-lg bg-white py-1 ps-2 pe-2 shadow-lg">Flat No. 22, Shriram Apartment
                                Plot No. 7, Linking Road
                                Bandra West
