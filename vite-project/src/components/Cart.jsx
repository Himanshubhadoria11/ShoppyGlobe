...
function Cart() {
    ...
    return (
        <section className="mt-20 min-[500px]:mt-28 px-5 pt-[40px]">
            <article className="relative">
                <h1 className="text-3xl min-[500px]:text-4xl font-bold after:absolute after:w-12 after:h-[6px] after:rounded-lg after:bg-purple-700 after:-bottom-2 after:left-0 text-red-600">Cart</h1>
            </article>
            {
                cartItems.length ?
                    ...
                    <section className="mt-10 mb-12 flex flex-col items-center">
                        <FontAwesomeIcon
                            icon={faCartShopping}
                            className="text-[8rem] min-[400px]:text-[10rem] text-red-700"
                        />
                        <h1 className="mt-5 text-xl min-[400px]:text-2xl font-semibold text-pink-600">Cart is Empty !</h1>
                        <Link to="/">
