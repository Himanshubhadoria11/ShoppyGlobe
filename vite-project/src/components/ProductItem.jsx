...
function ProductItem({ data }) {
    ...
    return (
        <article className="bg-blue-200 hover:border-2 hover:border-purple-700 border-white border-2 shadow-xl shadow-slate-400 rounded-md px-4  pb-4 pt-[40px]">
                ...
                { 
                    !itemAddedToCart ?
                        <button
                            ...
                            className="mt-5 font-semibold bg-purple-700 text-white px-5 py-[6px] rounded-md"
                        >
                            Add to Cart
                        </button>
                        :
                        ...
                        <Link to={`/product-details/${data?.id}`} className="mt-5 font-semibold bg-yellow-600 text-white px-5 py-[7px] text-center rounded-md">ProductDetails</Link>
                    </div>
